...
class AirSpiderWyglfw(feapder.AirSpider):
    '''
                       函数入口
                        :return:
               '''
    def start_requests(self):
        ...
        for page in range(1,6):
            if page==1:
                url="http://zjj.sz.gov.cn/ztfw/wyrq/xgzcjgfbz/index.html"
            else:
                url="http://zjj.sz.gov.cn/ztfw/wyrq/xgzcjgfbz/index_2.html"
...
if __name__ == "__main__":
    AirSpiderWyglfw(thread_count=1).start()
